...
export const en: TranslationKeys = {
  ...
  auction: {
    ...
    registered: 'Auction registered!',
    registerFailed: 'Failed to register auction.',
    ...
    invalidAmount: 'Please enter a valid amount.',
    bidHigherThanCurrent: 'Please enter an amount higher than current price ({price} KRW).',
    bid: 'Bid',
    bidding: 'Bidding...',
    enterBidAmount: 'Enter {price} KRW or more',
